          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="number" name="nomorspk" class="form-control" />	 
							</div>
                            </div>
							...
							<?php
								...
								$sql = $koneksi->query("insert into barang_keluar (id_transaksi, tanggal, kode_barang, nama_barang, jumlah, satuan, tujuan) values('$id_transaksi','$tanggal','$kode_barang','$nama_barang','$jumlah','$tujuan','$satuan')");
