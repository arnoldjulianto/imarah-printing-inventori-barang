...
$no = mysqli_query($koneksi, "select kode_barang from gudangimprint order by kode_barang desc");
 ...
 <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Tambah Stok Imprint</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
						...
						<label for="">Jenis Barang</label>
							...
							if (isset($_POST['simpan'])) {
								...
								$sql = $koneksi->query("insert into gudangimprint (kode_barang, nama_barang, jenis_barang, jumlah, satuan ) values('$kode_barang','$nama_barang','$jenis_barang','$jumlah','$satuan')");
