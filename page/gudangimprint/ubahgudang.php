...
<?php
 ...
 $sql2 = $koneksi->query("select * from gudangimprint where kode_barang = '$kode_barang'");
  ...
  <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Ubah Data Barang Imprint</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
						...
						<label for="">Jenis Barang</label>
							...
							<?php
								...
								$sql = $koneksi->query("update gudangimprint set kode_barang='$kode_barang', nama_barang='$nama_barang', jenis_barang='$jenis_barang', satuan='$satuan' where kode_barang='$kode_barang'"); 
